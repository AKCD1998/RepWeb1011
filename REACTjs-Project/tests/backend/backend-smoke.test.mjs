...
describe("backend HTTP baseline", () => {
  ...
  test.each([
    ...
    ["GET", "/api/admin/dispense-movements/00000000-0000-4000-8000-000000000000", null, 401],
    ["PATCH", "/api/admin/dispense-movements/00000000-0000-4000-8000-000000000000/correct-lot", { newLotId: "00000000-0000-4000-8000-000000000001", reason: "test" }, 401],
